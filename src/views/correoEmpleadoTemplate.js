...
function correoEmpleadoTemplate(nombre, correo, contraseña) {
...
<head>
	<meta charset="UTF-8">
	<title>Correo confirmación de Asignación de Credenciales</title>
...
box-shadow: 4px 7px 14px -1px rgba(99,99,99,1);">
		 			 ...
		 			 <table style="margin:10px; width: 80%; margin: auto; margin-bottom:20px;">
		 			    <tr>
		 			    	<td  style="color:#858580; font-weight: bold; text-align:center">
		 			    		...
		 			    		<p>Hola ${nombre}! Eres parte del equipo de trabajo Sascha, de ahora en adelante tus credenciales de acceso al sistema son:</p>
		 			    		<p>Correo: <a style="text-decoration:none;" href="">${correo}</a></p>
		 			    		<p>Contraseña: ${contraseña}</p>
		 			    		<h3 style="color:#3da3cb; font-family:arial">ENLACE A LA INTRANET</h3>
		 			    		<!-- enlace de descarga -->
                                <a style="background:#3da3cb; padding: 10px; min-width: 100px; border-radius: 5px; color:#fff; font-weight: bold; font-family: arial; text-decoration: none;" href="">Sascha Web Desktop</a></center>
		 			    	</td>
		 			    </tr> 	
		 			</table>
			 </td>
		...
		<tr style="border:none">
		<td style="border-top:1px solid gray; background: -prefix-linear-gradient(#1c6b34, #7ab740); background: linear-gradient(#1c6b34, #7ab740);" colspan="3" >
...
module.exports = correoEmpleadoTemplate